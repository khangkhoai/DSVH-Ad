...
const fields = [
  ...
  { key: "ten", label: "Ten Hoat Dong", _style: "min-width:150px" },
  { key: "batdau", label: "Bat Dau", _style: "min-width:150px" },
  { key: "ketthuc", label: "Ket Thuc", _style: "min-width:150px" },
  { key: "diadiem", label: "Dia Diem", _style: "min-width:150px" },
